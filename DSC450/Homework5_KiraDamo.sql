/*
    ...
    Due October 15th
    Kira Damo
    All queries are after table creation
...
SELECT DNAME AS DEPARTMENT_NAME, COUNT(E.DNO) AS NUMBER_EMPLOYEE
FROM DEPARTMENT D, EMPLOYEE E
WHERE D.DNUMBER = E.DNO
...
FROM EMPLOYEE
WHERE (SELECT MAX(SALARY) FROM EMPLOYEE E) - SALARY <= 28000;

SELECT FNAME, MINIT, LNAME, SEX
FROM EMPLOYEE
WHERE SEX = 'F';

SELECT FNAME, MINIT, LNAME, SEX FROM
